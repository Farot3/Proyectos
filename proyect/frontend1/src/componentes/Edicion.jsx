    ...
    const handleSubmit = async (event) => {
        ...
        try{
            const response = await fetch('http://localhost:5000/update', {
                ...
                body: JSON.stringify({carnet, password, nombre, apellidos, facultad, genero, correo, carrera}),
    ...
    return (
        <div className = 'd-flex align-items-center justify-content-center' style={{minHeight : '102vh'}}>
            ...
            <div className="row">
                ...
                <button className="btn btn-success w-100 py-2" type="submit" >Actualizar</button>
            </form>
            </div>
        </div>
