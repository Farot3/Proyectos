    ...
    <div className="d-flex flex-nowrap">?
        <div className="d-flex flex-column flex-shrink-0 bg-body-tertiary" style={{ width: '4.5rem' }}>
          <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li>
              <Link to="/create" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'Create' && 'active'}`} aria-current="page" title="Crear Post" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-earmark-post" viewBox="0 0 16 16">
            ...
            <li>
              <Link to="/list" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'posts' && 'active'}`} title="Posts" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <li>
              <Link to="/reportes" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'reportes' && 'active'}`} title="Reportes" data-bs-toggle="tooltip" data-bs-placement="right">
          ...
          <div className="dropdown border-top">
            <Link to="/profile" className="d-flex align-items-center justify-content-center p-3 link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="https://w0.peakpx.com/wallpaper/459/108/HD-wallpaper-fairy-tail-logo-fairy-tail-logo-anime-colours-smoke.jpg" alt="mdo" width="24" height="24" className="rounded-circle" />
            </Link>
            <ul className="dropdown-menu text-small shadow">
              <li><Link className="dropdown-item" to="/edición">Editar Perfil</Link></li>
