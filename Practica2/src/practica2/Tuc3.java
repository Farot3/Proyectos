...
public class Tuc3 extends Thread implements Serializable{
  ...
  boolean detenida = false; 
    ...
    int distanciaViaje = obtenerDistanciaViaje("Vehículo estandar 3");
    ...
    public int totalGasolinaUtilizada6 = (int) (distanciaViaje * gastoCombu);
   
    public Tuc3(Ventana ventana) {
        this.ventana = ventana;
        this.posmotx = this.ventana.labeltuc3.getX();
        this.posmoty = this.ventana.labeltuc3.getY();
        this.distanciaActual = ventana.getDistanciaActualTuc3();
  ...
  @Override
    public void run() { // La distancia actual recorrida por la imagen
     ...
     if(posmotx<935){
        while (distanciaActuals < mac) {   
            ...
            ventana.GasTuc3.setLocation(posmotx + 160, posmoty + 20);
            ventana.GasTuc3.setText("Gasolina actual: " + bEntero);
            ventana.distanTuc3.setLocation(posmotx + 20, posmoty);
            ventana.distanTuc3.setText("Recorrido: " + aEntero + " km");
            if (b <= 0) {
                detenida = true;
                break;
            }
        ...
        if (detenida) {
            ventana.GassTuc3.setVisible(true);
            ventana.GassTuc3.setLocation(posmotx + 150, posmoty);
            }
                    ventana.setDistanciaActualTuc3(distanciaActual);
    }else if(posmotx >= 935){
    ...
    ventana.labeltuc3.setLocation(posmotx, posmoty);
    ...
    private void moveRight(int pixels) {
        ventana.GassTuc3.setVisible(false);
        ...
        ventana.labeltuc3.setLocation(x, y);       
        ventana.GasTuc3.setLocation(posmotx + 160, posmoty + 20);
        ventana.distanTuc3.setLocation(posmotx + 20, posmoty);
