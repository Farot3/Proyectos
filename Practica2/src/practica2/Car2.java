...
public class Car2 extends Thread implements Serializable{
    ...
    int distanciaViaje = obtenerDistanciaViaje("Vehículo Premium 2");
    ...
    public int totalGasolinaUtilizada8 = (int) (distanciaViaje * gastoCombu);
    
    public Car2(Ventana ventana) {
        this.ventana = ventana;
        this.posmotx = this.ventana.labelcar2.getX();
        this.posmoty = this.ventana.labelcar2.getY();
        this.distanciaActual = ventana.getDistanciaActualCar2();
...
if(posmotx<910){
        while (distanciaActuals < mac) {   
            ...
            ventana.GarCar2.setLocation(posmotx + 160, posmoty + 20);
            ventana.GarCar2.setText("Gasolina actual: " + bEntero);
            ventana.DistanCar2.setLocation(posmotx + 20, posmoty);
            ventana.DistanCar2.setText("Recorrido: " + aEntero + " km");
            try {
            ...
            if (b <= 0) {
                ...
                break;
                    ...
                    if (detenida) {
            ventana.GassCar2.setVisible(true);
            ventana.GassCar2.setLocation(posmotx + 150, posmoty);
            }
                    ventana.setDistanciaActualCar2(distanciaActual);
    }else if(posmotx >= 910){
    ...
    ventana.labelcar2.setLocation(posmotx, posmoty);
    ...
    private void moveRight(int pixels) {
        ventana.GassCar2.setVisible(false);
        ...
        ventana.labelcar2.setLocation(x, y);       
        ventana.GarCar2.setLocation(posmotx + 160, posmoty + 20);
        ventana.DistanCar2.setLocation(posmotx + 20, posmoty);
