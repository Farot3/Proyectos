...
public class Motocicleta extends Thread implements Serializable{
    ...
    public int totalGasolinaUtilizada = (int) (distanciaViaje * gastoCombu);

    public Motocicleta(Ventana ventana) {
        this.ventana = ventana;
        this.posmotx = this.ventana.labelImagen.getX();
        this.posmoty = this.ventana.labelImagen.getY();
        this.distanciaActual = ventana.getDistanciaActual();
...
if(posmotx<910){
        while (distanciaActuals < mac) {   
            ...
            ventana.Gasmot.setLocation(posmotx + 160, posmoty + 20);
            ventana.Gasmot.setText("Gasolina actual: " + bEntero);
            ventana.Distanciamot.setLocation(posmotx + 20, posmoty);
            ventana.Distanciamot.setText("Recorrido: " + aEntero + " km");
            try {
            ...
            if (b <= 0) {
                ...
                break;
                    ...
                    if (detenida) {
            ventana.GassMot.setVisible(true);
            ventana.GassMot.setLocation(posmotx + 150, posmoty);
            }
                    ventana.setDistanciaActual(distanciaActual);
    }else if(posmotx >= 910){
    ...
    ventana.labelImagen.setLocation(posmotx, posmoty);
    ...
    private void moveRight(int pixels) {
        ventana.GassMot.setVisible(false);
        ...
        ventana.labelImagen.setLocation(x, y);       
        ventana.Gasmot.setLocation(posmotx + 160, posmoty + 20);
        ventana.Distanciamot.setLocation(posmotx + 20, posmoty);
